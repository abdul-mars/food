<?php $title = 'Home - Food Delivery';
    require_once 'inc/header.php'; ?>

    <div class="main-content">
            <div class="text-center my-4">
                <h4>Popular Dishes of the Month</h4>
                <h5>Most Popular Foods</h5>
            </div>
        <div class="container">
            <!-- <h1 class="section-title">Our Menu</h1> -->
            <div class="food-grid">
                <?php $sql = mysqli_query($con, "SELECT * FROM menus LIMIT 4");
                ...
                <h5><a href="menu.php">See All Foods</a></h5>
            </div>
        </div>
    </div>
